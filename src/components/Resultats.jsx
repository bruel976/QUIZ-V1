...
export default function Resultats({ etudiant, resultat, onRecommencer }) {
  const reussite = resultat.noteSur20 >= 10

  function telecharger() {
    genererPDF({ nom: etudiant.nom, prenom: etudiant.prenom, resultat })
  }

  return (
    <div className="resultats">
      <div className="badge-marque">Résultat</div>
      <h1 className="titre-principal">Quiz terminé !</h1>
      <p className="sous-titre">
        Bravo {etudiant.prenom} {etudiant.nom}
      </p>
